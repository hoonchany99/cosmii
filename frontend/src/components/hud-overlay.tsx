...
export function HudOverlay({ onOpenProfile }: HudOverlayProps) {
  ...
  return (
    <div className="absolute top-14 w-full px-6 flex justify-between items-center z-30 pointer-events-none">
      <h1 className={`${serif} text-white/80 text-[20px] font-bold tracking-[0.02em] pointer-events-auto`}>
        Cosmii
      </h1>

      <div className="flex gap-2 pointer-events-auto">
        <div className="flex items-center gap-1.5 bg-white/[0.06] border border-white/[0.12] px-3 py-1.5 rounded-full backdrop-blur-md">
        ...
        <motion.button
          ...
          className="bg-indigo-500/15 border border-indigo-400/30 backdrop-blur-md rounded-full w-8 h-8 flex items-center justify-center active:bg-indigo-500/30 transition-colors"
        >
