...
export default function PrivacyPage() {
  return (
    <ReaderPage title="개인정보처리방침" note="시행일: 2026년 9월 19일" current="/privacy">
      <section>
        ...
        <p className="mt-3">광고 식별자(IDFA)를 수집하지 않고, 다른 회사의 앱이나 웹사이트를 넘나들며 이용자를 추적하지 않습니다. 사용 통계는 광고에 쓰지 않습니다.</p>
      </section>
      ...
      <section>
        ...
        <ul className="mt-3 space-y-2 list-disc list-outside ml-5">
          ...
          <li><strong className={strong}>Apple, Google</strong> — 로그인, Apple은 결제</li>
        </ul>
