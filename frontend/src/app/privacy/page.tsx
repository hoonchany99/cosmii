  ...
  return (
    <div className="min-h-screen bg-[#060612] text-white">
      <div className="max-w-2xl mx-auto px-6 sm:px-12 py-24">
        ...
        <p className="text-[13px] text-white/25 mb-16">시행일: 2026년 9월 15일</p>
        ...
        <div className="space-y-12 text-[15px] text-white/50 leading-[1.85] break-keep">
          <section>
            ...
            <ul className="space-y-2 list-disc list-outside ml-5">
              ...
              <li>
                <strong className={strong}>읽기 기록</strong> — 로그인한 경우 읽은 장, 퀴즈 결과, 별(XP), 레벨, 연속 읽기 일수, 앱이 만든 닉네임을 저장합니다. 로그인하지 않으면 이 기록은 기기에만 저장되고, 나중에 로그인할 때 계정으로 옮겨집니다.
              </li>
              <li>
                <strong className={strong}>코스미와의 대화</strong> — 대화 기록은 기기에만 저장되며 저희 서버에 보관하지 않습니다. 답을 만들 때 전송되는 내용은 아래 3항에 적었습니다.
              </li>
              <li>
                <strong className={strong}>기기에만 남는 정보</strong> — 읽기 알림 시간, 하루 목표, 장서표와 히든 책 상태 같은 설정은 기기에 저장됩니다. 알림은 기기에서 예약되며 서버로 전송되지 않습니다.
              </li>
            </ul>
