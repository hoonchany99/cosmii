...
const h2 = "text-[14px] font-medium text-white/75 tracking-wide mb-4";
const strong = "text-white/65";
  ...
  return (
    <div className="min-h-screen bg-[#060612] text-white">
      <div className="max-w-2xl mx-auto px-6 sm:px-12 py-24">
        ...
        <p className="text-[13px] text-white/25 mb-16">시행일: 2026년 9월 16일</p>

        <div className="space-y-12 text-[15px] text-white/50 leading-[1.85] break-keep">
          <section>
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-outside ml-5">
              <li><strong className={strong}>책을 여는 방법</strong> — 서가의 책은 봉인된 상태로 있으며, 제목 대신 한 줄의 쪽지만 보입니다. 봉인을 뜯으면 그 책을 끝까지 읽을 수 있습니다. 매주 월요일 봉인된 책 세 권이 도착합니다.</li>
              <li><strong className={strong}>무료</strong> — 매주 도착한 세 권 중 한 권을 별빛 없이 뜯을 수 있고, 그 밖의 책은 별빛으로 엽니다. Cosmii와의 대화는 하루 정해진 횟수까지, 목소리는 책마다 첫 장까지 들을 수 있습니다.</li>
          ...
          <section>
            ...
            <p>
              별빛은 장을 읽고 퀴즈를 맞히면 쌓이는 앱 안의 점수로, 봉인된 책을 여는 데 쓸 수 있습니다. 별빛은 돈으로 사거나 현금으로 바꾸거나 다른 사람에게 넘길 수 없고, 계정을 삭제하면 함께 사라집니다. 별빛으로 얻을 수 있는 것은 운영에 따라 바뀔 수 있습니다.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <a
                href="mailto:privacy@cosmii.app"
                className="text-white/65 underline underline-offset-4 decoration-white/20 hover:decoration-white/50 transition-colors duration-300"
              >
                privacy@cosmii.app
              </a>
            </p>
