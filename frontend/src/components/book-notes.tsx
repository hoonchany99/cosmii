    ...
    <div className="w-full h-full relative overflow-hidden text-white">
      ...
      <div className="absolute top-14 w-full px-5 flex items-center z-20">
        ...
        <div className="ml-2">
          ...
          <p className="text-white/30 text-[12px]">{bookTitle}</p>
        </div>
      </div>
            ...
            {chapters.length > 1 && (
              ...
              >
                <div className="flex items-center gap-1.5 mb-2.5">
                  ...
                  <span className="text-white/30 text-[12px] uppercase tracking-[0.12em] font-bold">{t("notes.chapter")}</span>
                </div>
                ...
                {filtered.map((note, i) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-white/50 text-[13px] font-semibold truncate">
                        {note.lessonTitle}
                      </span>
                    </div>

                    <p className="text-white/75 text-[15px] leading-[1.7] font-medium">
                      {note.spark}
                    </p>
