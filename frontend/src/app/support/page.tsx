...
const link =
  "text-white/65 underline underline-offset-4 decoration-white/20 hover:decoration-white/50 transition-colors duration-300";
  ...
  return (
    <div className="min-h-screen bg-[#060612] text-white">
      <div className="max-w-2xl mx-auto px-6 sm:px-12 py-24">
        ...
        <p className="text-[13px] text-white/25 mb-16">
          막히는 것이 있으면 언제든 메일 주세요. 하루 안에 답합니다.
        </p>
        ...
        <div className="space-y-12 text-[15px] text-white/50 leading-[1.85] break-keep">
          <section>
            ...
            <p>
              <a href="mailto:hello@cosmii.app" className={link}>
                hello@cosmii.app
              </a>
            </p>
          ...
          <section>
            <h2 className={h2}>그 밖에</h2>
            <p>
              <a href="/terms" className={link}>이용약관</a>
              <span className="text-white/20"> · </span>
              <a href="/privacy" className={link}>개인정보처리방침</a>
            </p>
          </section>
        </div>
      </div>
