    ...
    <ReaderPage title="이용약관" note="시행일: 2026년 9월 17일" current="/terms">
      ...
      <section>
        ...
        <ul className="space-y-2 list-disc list-outside ml-5">
          ...
          <li><strong className={strong}>Cosmii의 서점</strong> — 그 밖의 책은 서점에서 고릅니다. 제목과 표지를 보고 고르면 별빛 600, 쪽지만 보고 고르면 별빛 300으로 엽니다. 쪽지로 고른 책의 제목은 봉인을 뜯어야 보입니다.</li>
          <li><strong className={strong}>무료</strong> — 처음 여는 책 한 권은 서점에서든 도착한 책 중에서든 별빛 없이 엽니다. 매주 도착한 세 권 중 한 권도 별빛 없이 뜯을 수 있고, 그보다 더 뜯으면 한 권에 별빛 300이 듭니다. Cosmii와의 대화는 하루 정해진 횟수까지, 목소리는 책마다 첫 장까지 들을 수 있습니다.</li>
